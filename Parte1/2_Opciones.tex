...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \end{subfigure}
            \begin{subfigure}[b]{0.45\linewidth}
            \includegraphics[width=\linewidth]{Imagenes/Parte1/2_Derivados/ProfitDiagPut.pdf}
            \caption{Put option}
        \end{subfigure}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{Imagenes/Parte1/2_Derivados/StrangleITMPayoff.pdf}
            \caption{Payoff de Strangle ITM}
        \end{figure}
    \end{itemize}
    \item \textbf{Risk Reversal}: comprar/vender una call con strike mayor que el precio actual y vender/comprar una put con un strike inferior al precio actual. Se apuesta a que el subyacente va a subir (y que como mucho no va a bajar demasiado) o al contrario. Se puede perder dinero, pero las primas son más baratas. Su payoff sería:
    \begin{itemize}
        \item \textbf{Bullish risk reversal}:
        \[\boxed{\max(S-E_C, 0) - \max(E_P-S, 0)}\]
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{Imagenes/Parte1/2_Derivados/BullishRiskReversalPayoff.pdf}
            \caption{Payoff de Risk Reversal a vencimiento}
        \end{figure}
        \item \textbf{Bearish risk reversal}:
        \[\boxed{\max(E_P-S, 0) - \max(S-E_C, 0)}\]
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{Imagenes/Parte1/2_Derivados/BearishRiskReversalPayoff.pdf}
            \caption{Payoff de Risk Reversal a vencimiento}
        \end{figure}
    \end{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{Imagenes/Parte1/2_Derivados/ButterflyPayoff.pdf}
